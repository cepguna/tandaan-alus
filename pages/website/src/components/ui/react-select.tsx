...
const selectStyles = {
  ...
  menu: 'mt-1.5 p-1.5 border border-input bg-background text-sm rounded-lg z-[10000]',
  menuList: 'morel-scrollbar z-[10000]',
...
export const ReactSelect = React.forwardRef(BaseSelect) as <IsMulti extends boolean = false>(
